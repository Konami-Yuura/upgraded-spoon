        ...
        <div class="col-8">
            <form action="{{route('profile.update')}}" method="POST" class="bg-white shadow rounded-3 p-5" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-4">
                        @if ($user->avatar)
                            <img src="{{$user->avatar}}" alt="{{$user->name}}" class="img-thumbnail rounded-circle d-block mx-suto avatar-lg">
                        @else
                            <i class="fa-solid fa-circle-user text-secondary d-block test-center icon-lg"></i>
                        @endif
                    </div>
                    ...
                    <div class="col-auto align-self-end">
                        ...
                        <div class="form-text" id="avatar-info">
                            Acceptable formats: jpeg, jpg, png, git only <br>
                            Max fille size is 1048kb
                        </div>
